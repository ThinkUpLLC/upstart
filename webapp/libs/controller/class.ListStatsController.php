...
class ListStatsController extends Controller {
    public function control() {
        ...
        $daily_paid_subscribers = $subscriber_dao->getDailyPaidSubscriberCounts($since = '2016-01-01');
        // Get paid subscribers on Recurly
        $daily_paid_recurly_subscribers = $subscriber_dao->getDailyPaidRecurlySubscriberCounts($since = '2016-01-01');
