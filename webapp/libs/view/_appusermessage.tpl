{if isset($field)}
    {if isset($success_msgs.$field)}
       <div class="message success"><i class="icon icon-ok-sign"></i>
    ...
    <div class="message warning"><i class="icon icon-warning-sign"></i>
    ...
    {if isset($success_msgs.$field) OR isset($error_msgs.$field)}<br />{/if}
        <div class="message info"><i class="icon icon-info-sign"></i>
