...
body_classes="marketing marketing-page" body_id="marketing-faq"}
  ...
  <div class="container">
    ...
    <section class="section col-md-2 col-lg-3 col-lg-right section-legal-text" id="section-legal-text">
      ...
      <h4 id="language-support"><a href=#language-support">Language Support</a></h4>
      
      <p>While we plan to support multiple languages in the future ThinkUp currently has several features that work best for users who primarily use English for Facebook and Twitter activity.</p>
      ...
      <p>ThinkUp is cofounded by <a href="http://ginatrapani.org/">Gina Trapani</a> and <a href="http://anildash.com/">Anil Dash</a>, and is based in New York City. You can find out information about our investors on <a href="{$site_root_path}about/">our about page</a>. ThinkUp's launch was crowdfunded by our members in a very successful campaign in the autumn of 2013. (You can check out our <a href="https://www.youtube.com/watch?v=TeqeSmBwpcw">launch video</a> to see how we got started.)</p>
