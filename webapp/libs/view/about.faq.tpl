...
body_classes="marketing marketing-page" body_id="marketing-faq"}
  ...
  <div class="container">
    ...
    <section class="section col-md-2 col-lg-3 col-lg-right section-legal-text" id="section-legal-text">
      ...
      <h4 id="reconnect-facebook">Why do I have to reconnect my Facebook account once in awhile?</h4>
      ...
      <p>Send an email help@thinkup.com with the change you’d like made and we’ll take care of it for you.</p>
