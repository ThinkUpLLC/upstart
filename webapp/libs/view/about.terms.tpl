...
body_classes="marketing marketing-page" body_id="marketing-terms"}
  ...
  <div class="container">
    ...
    <section class="section col-md-2 col-lg-3 col-lg-right section-legal-text">
      ...
      suggestions for improvement, feel free to email us at <a href="mailto:help@thinkup.com">help@thinkup.com</a>. We&#39;ve
      ...
      to emphasize key sections.</p>
      <h3 class="hc">1. Accepting the Terms of Service</h3>
      <blockquote>
      &ldquo;We are ThinkUp and you&#39;re agreeing to these terms.&rdquo;
      </blockquote>
      <p>These are some of the definitions we&#39;ll use in this contract:</p>
      <ul>
      <li>&ldquo;Agreement&rdquo;: These Terms of Service, along with our Privacy Policy.</li>
      <li>&ldquo;Services&rdquo;: ThinkUp.com and/or the other domains, products, services, and/or
      content provided by ThinkUp LLC.</li>
      <li>&ldquo;ThinkUp&rdquo;: ThinkUp LLC., a Delaware limited liability company. Also known
      as &ldquo;we&rdquo; or &ldquo;us&rdquo;.</li>
      <li>&ldquo;Subscriber&rdquo;: That is you, who we&#39;ll also call &ldquo;you&rdquo;.</li>
      </ul>
      <p>By creating a Services Account or using or accessing the Services, you agree
      ...
      Services.</p>
      <h3 class="hc">2. Modifications to this Agreement</h3>
      <blockquote>
      &ldquo;We can change this agreement if needed, and when we do, we&#39;ll let you know.&rdquo;
      </blockquote>
      <p>ThinkUp may make modifications, deletions and/or additions to this Agreement
      (&ldquo;Changes&rdquo;) at any time.  Changes will be effective: (i) thirty (30) days
      ...
      incorporating the Changes, whichever comes first.</p>
      <h3 class="hc">3. Use of the Services</h3>
      <h4>Eligibility:</h4>
      <blockquote>
      &ldquo;You have to be eighteen or older.&rdquo;
      </blockquote>
      <p>No individual under the age of eighteen (18) may use the Services or
      ...
      information to ThinkUp, please contact us at <a href="mailto:help@thinkup.com">help@thinkup.com</a>. You
      otherwise may only use the Services if you are not legally prohibited from
      using the Services.</p>
      <h4>Service Changes and Limitations:</h4>
      <blockquote>
      &ldquo;We are going to be changing and updating the service regularly.&rdquo;
      </blockquote>
      <p>The Services may change frequently, and their form and functionality may
      ...
      or of changes to these limits, whenever possible.</p>
      <p>ThinkUp may also impose limits on certain  Services or aspects of those
      ...
      any time, in its sole discretion.</p>
      <h4>Limitations on Automated Use:</h4>
      <blockquote>
      &ldquo;You shouldn&#39;t use bots or access the system in undocumented ways.&rdquo;
      </blockquote>
      <p>You may not do any of the following while accessing or using the Services:
      ...
      on the Services.</p>
      <h3 class="hc">4. Registration, ThinkUp URLs, and Security</h3>
      <blockquote>
      &ldquo;Use accurate information when you register, and keep your password safe.&rdquo;
      </blockquote>
      <p>As a condition to using certain of the Services, you may be required to
      create an account (an &ldquo;Account&rdquo;) and select a password and ThinkUp username,
      which will serve as a default URL of the form [username].thinkup.com (a
      &ldquo;ThinkUp URL&rdquo;).</p>
      <p>You must provide ThinkUp with accurate, complete, and updated registration
      information, particularly your e-mail address, and failure to do so may
      result in suspension of your Account.</p>
      <p>You agree that you shall not select or use as a ThinkUp URL a name of another
      ...
      of, cancel, or modify a ThinkUp URL in its sole discretion.</p>
      <p>You are also responsible for maintaining the confidentiality of your Account
      ...
      occurring under your Account.</p>
      <h3 class="hc">5. Privacy</h3>
      <blockquote>
      ...
      <h4>Definitions:</h4>
      <blockquote>
      &ldquo;Content meants text, pictures and other stuff; Subscriber Content is your
      stuff.&rdquo;
      </blockquote>
      <p>For purposes of this Agreement: (1) the term &ldquo;Content&rdquo; means any work of
      ...
      files, graphics, and interactive features; (2) the term &ldquo;Subscriber
      Content&rdquo; is all Content made available through user social networking
      accounts (such as a Facebook or Twitter account) that registered users of
      the Services link to their Accounts, such as pictures and Tweets.</p>
      <h4>Ownership:</h4>
      <blockquote>
      &ldquo;You own your stuff, and we own our stuff.&rdquo;
      </blockquote>
      <p>As between you and ThinkUp, you retain ownership of all intellectual
      ...
      your Subscriber Content).  </p>
      <h4>Content License from You:</h4>
      <blockquote>
      &ldquo;You allow us to use your content in the context of using running our
      services and operating our business.&rdquo;
      </blockquote>
      <p>As a Subscriber of the Services, you grant to ThinkUp a worldwide,
      ...
      without limitation for analyzing usage of and improving its Services.</p>
      <h4>Subscriber Content:</h4>
      <blockquote>
      &ldquo;You have the right to let us use your content.  We don&rsquo;t warrant other
      user&rsquo;s content.&rdquo;
      </blockquote>
      <p>You represent and warrant that you either own your Subscriber Content or
      ...
      Agreement.</p>
      <h4>Termination and Deletion:</h4>
      <blockquote>
      &ldquo;We&#39;ll try to delete your information if you cancel your account.&rdquo;
      </blockquote>
      <p>On termination of your Account or upon your deletion of particular pieces
      ...
      others) for a reasonable period of time.</p>
      <h3 class="hc">7. Use of Trademarks</h3>
      <blockquote>
      &ldquo;You must get our permission to use our ThinkUp branding and trademarks.&rdquo;
      </blockquote>
      <p>Any use of ThinkUp&#39;s trademarks, branding, logos and other such assets
      requires the express written permission of ThinkUp. If you need to use these
      assets, contact us at <a href="mailto:help@thinkup.com">help@thinkup.com</a>. Any such use will be subject to
      compliance with our trademark guidelines.</p>
      <h3 class="hc">8. Paid Services</h3>
      <blockquote>
      &ldquo;Paying gives you access to a set of Paid Services for a period of time.&rdquo;
      </blockquote>
      <p>Some of the Services require payment of fees (the &ldquo;Paid Services&rdquo;). All
      ...
      connection with Paid Services.</p>
      <p>Purchases of Paid Services are final and non-refundable, except at ThinkUp&#39;s
      ...
      result in forfeiture of existing Paid Services.</p>
      <p>ThinkUp may change its prices for Paid Services at any time. To the extent
      ...
      Service prior to the change going into effect.</p>
      <h3 class="hc">9. Warranty Disclaimer; Services Available on an &ldquo;AS-IS&rdquo; Basis</h3>
      <blockquote>
      &ldquo;We want ThinkUp to be great for you, but it&#39;s not warrantied.&rdquo;
      </blockquote>
      <p>YOUR ACCESS TO AND USE OF THE SERVICES OR ANY CONTENT IS AT YOUR OWN RISK.
      ...
      THE SERVICES ARE PROVIDED TO YOU ON AN &ldquo;AS IS&rdquo; AND &ldquo;AS AVAILABLE&rdquo; BASIS.
      ...
      any warranty not expressly made herein.</p>
      <h3 class="hc">10. Release From Liability</h3>
      <blockquote>
      &ldquo;We&#39;re not liable for certain issues that could arise from using ThinkUp.&rdquo;
      </blockquote>
      <p>You release, to the fullest extent permitted by law, ThinkUp, its directors,
      ...
      following:</p>
      <ul>
      <li>Disputes between Subscribers, including those between you and other
      Subscribers.</li>
      <li>Third party sites and services, including content found on such sites
      and services.</li>
      <li>Disputes concerning any use of or action taken using your Account by you
      or a third party.</li>
      <li>Claims relating to the unauthorized access to any data communications or
      ...
      <p>You hereby waive applicability of California Civil Code §1542, and any
      similar statute or principle of common law. California Civil Code §1542 says:
      &ldquo;A general release does not extend to claims which the creditor does not
      know or suspect to exist in his or her favor at the time of executing the
      release, which if known by him or her must have materially affected his or
      her settlement with the debtor.&rdquo;
      <h3 class="hc">11. Limitation of Liability</h3>
      <blockquote>
      &ldquo;As much as the law allows, ThinkUp and its team isn&#39;t liable for certain
      types of damages. ThinkUp&#39;s total liability to you is limited, too.&rdquo;
      </blockquote>
      <p>TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THINKUP, ITS DIRECTORS,
      OFFICERS, MEMBERS, EMPLOYEES, REPRESENTATIVES, CONSULTANTS, AGENTS,
      ...
      ESSENTIAL PURPOSE.</p>
      <p>TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE TOTAL LIABILITY OF
      ...
      PPLICABLE SERVICE(S).</p>
      <h3 class="hc">12. Exclusions to Warranties and Limitation of Liability</h3>
      <blockquote>
      &ldquo;We follow the law of your region in regard to warranties and liabilities.&rdquo;
      </blockquote>
      <p>Some jurisdictions may not allow the exclusion of certain warranties or the
      exclusion/limitation of liability as set forth in Section 14, so the
      limitations above may not apply to you.</p>
      <h3 class="hc">13. Legal Compliance; Indemnification</h3>
      <blockquote>
      &ldquo;You won&#39;t use ThinkUp to do illegal things.&rdquo;
      </blockquote>
      <p>As a condition of your use of the Services, you represent and warrant that
      ...
      Internet, technology, data, email and privacy.</p>
      <p>You agree to indemnify and hold ThinkUp, and its directors, officers,
      ...
      settlements, costs or expenses, including attorney&rsquo;s fees, arising out of or
      relating to your use or misuse of the Services, violation of this Agreement
      or violation of the rights of any other person or entity.</p>
      <h3 class="hc">14. Termination</h3>
      <blockquote>
      &ldquo;If you want to cancel this agreement, just cancel your account. Same goes
      for us.&rdquo;
      </blockquote>
      <p>Either party may terminate this Agreement at any time by notifying the other
      ...
      infringement.</p>
      <p>Upon termination of your access to or ability to use a Service, including
      ...
      any liability which you otherwise may have to ThinkUp or any third party.</p>
      <h3 class="hc">15. Arbitration</h3>
      <blockquote>
      &ldquo;If there&#39;s a dispute, we&#39;ll arbitrate instead of going to court.&rdquo;
      </blockquote>
      <p>&ldquo;We will arbitrate certain disputes instead of going to court.&rdquo;
      ...
      arbitration initiated through the American Arbitration Association (&ldquo;AAA&rdquo;).
      ...
      <h3 class="hc">16. Jurisdiction</h3>
      <blockquote>
      &ldquo;This agreement is covered by New York law.  If there is a dispute between us
      not subject to arbitration, we&#39;ll handle it in New York.&rdquo;
      </blockquote>
      <p>Before resorting to litigation, we strongly encourage you to contact us at
      <a href="mailto:help@thinkup.com">help@thinkup.com</a> to seek a resolution.</p>
      <p>This Agreement shall be governed in all respects by the laws of the State of
      ...
      against ThinkUp that isn&rsquo;t subject to mandatory arbitration under Section 14
      ...
      disputes.</p>
      <h3 class="hc">17. Special Provisions for Subscribers Located Outside of the United States</h3>
      <blockquote>
      &ldquo;We&#39;re in the United States, so we&#39;ll follow U.S. law.&rdquo;
      </blockquote>
      <p>ThinkUp provides global products and services and enables a global community
      ...
      Department&#39;s list of &ldquo;Specially Designated Nationals,&rdquo; you agree that you
      will not use the Services.</p>
      <h3 class="hc">18. Miscellaneous</h3>
      <blockquote>
      &ldquo;This is the whole agreement between us.&rdquo;
      </blockquote>
      <p>This Agreement, including as it may be modified from time to time as set
      ...
      <a href="mailto:team@thinkup.com">team@thinkup.com</a> or by telephone at +1 646 833 8659. </p>
      <h3 class="hc">19. Special Notice to California Residents</h3>
      <blockquote>
      &ldquo;The state of California makes us tell you this.&rdquo;</p>
      </blockquote>
      <p>If you are a California resident, we are required to inform you that you may
      ...
      Unit at TDD (800) 326-2297 or TDD (916) 322-1700.</p>
      <h3 class="hc">Link to Prior Versions</h3>
      <blockquote>
      &ldquo;You can see the changes we&#39;ve made to this agreement.&rdquo;
      </blockquote>
      <p>You will find a link to prior versions of our Terms of Service below. We
      have stored these versions on GitHub, which will also allow you to
      compare different versions and see what terms have changed:</p>
