...
style="background-color:#125C9C;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:200px;margin-bottom:20px;-webkit-text-size-adjust:none;">Fix my membership!</a>
  <!--[if mso]>
    </center>
  </v:roundrect>
<![endif]--></div>
