...
<div class="container" id="container-navbar">
    {if isset($show_promo)}<div class="promo-bar"><img src="{$site_root_path}assets/img/good-web-bundle-logo.svg" alt="Good Web Bundle logo"> Join ThinkUp for 50% off, and support 4 other great sites: It's the <a href="#">Good Web Bundle</a>!</div>{/if}
