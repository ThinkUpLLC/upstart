...
<div class="container" id="container-navbar">
    {if isset($show_promo)}<div class="promo-bar"><a href="https://goodwebbundle.com"><img src="{$site_root_path}bundle/assets/img/good-web-bundle-logo-white.svg" alt="Good Web Bundle logo"> Save 50% on ThinkUp, and support 4 other great sites: It's the Good Web Bundle!</a></div>{/if}
