...
<div class="container" id="container-navbar">
    {if isset($show_promo)}<div class="promo-bar"><a href="https://makerba.se"><strong>NEW:</strong> Makerbase is a directory of makers &amp; digital projects. Add yourself now!</a></div>{/if}
