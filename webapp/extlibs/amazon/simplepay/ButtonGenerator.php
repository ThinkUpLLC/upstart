...
class ButtonGenerator {
     ...
     * @throws Exception
     */
	public static function getSimplePayStandardParams($accessKey,$amount, $recurringFrequency, $description,
	...
	public static function getSimplePayStandardForm(array $formHiddenInputs,$endPoint,$imageLocation) {
        ...
        $form .= "<input type=\"submit\" class=\"btn btn-pill-large has-note\" value=\"Pay now with Amazon\n ".
            $formHiddenInputs["amount"]." per ".$formHiddenInputs["recurringFrequency"]."\" border=\"0\">\n";
	 ...
	 public static function generateForm($accessKey, $secretKey, $amount, $recurringFrequency, $description,
            $referenceId, $immediateReturn, $returnUrl, $abandonUrl, $processImmediate, $ipnUrl,$collectShippingAddress,
        ...
        $params = self::getSimplePayStandardParams($accessKey, $amount, $recurringFrequency, $description, $referenceId,
