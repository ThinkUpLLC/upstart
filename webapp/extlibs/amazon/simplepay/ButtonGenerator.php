...
class ButtonGenerator {
     ...
     * @param recurringFrequency - Enter the amount you want to collect for the item
     ...
     * @throws Exception
     */
	public static function getSimplePaySubscriptionParams($accessKey,$amount, $recurringFrequency, $description,
            $referenceId, $immediateReturn, $returnUrl, $abandonUrl, $processImmediate, $ipnUrl,
            $collectShippingAddress, $signatureMethod) {
        $formHiddenInputs = self::getSimplePayStandardParams($accessKey, $amount, $description,
            $referenceId, $immediateReturn, $returnUrl, $abandonUrl, $processImmediate, $ipnUrl,
            $collectShippingAddress, $signatureMethod);
     ...
     * @throws Exception
     */
    public static function getSimplePayStandardParams($accessKey, $amount, $description,
            $referenceId, $immediateReturn, $returnUrl, $abandonUrl, $processImmediate, $ipnUrl,
            $collectShippingAddress, $signatureMethod) {
     ...
     */
	public static function getSimplePaySubscribeForm(array $formHiddenInputs,$endPoint,$imageLocation) {
        ...
        $form .= "<button type=\"submit\" class=\"btn-pill-large has-note\">Pay now with Amazon<br>\n<small>".
            $buttonAmount." a ".$buttonFreq."</small></button>\n";
     ...
     * @throws Exception
     */
     public static function generateStandardForm($accessKey, $secretKey, $amount, $description, $referenceId,
        $immediateReturn, $returnUrl, $abandonUrl, $processImmediate, $ipnUrl, $collectShippingAddress,
     ...
     * @throws Exception
     */
	 public static function generateSubscriptionForm($accessKey, $secretKey, $amount, $recurringFrequency, $description,
            $referenceId, $immediateReturn, $returnUrl, $abandonUrl, $processImmediate, $ipnUrl,$collectShippingAddress,
            $signatureMethod, $environment) {
		if ($environment=="prod"){
			$endPoint = self::$PROD_END_POINT;
            $imageLocation = self::$PROD_IMAGE_LOCATION;
        ...
        $params = self::getSimplePaySubscriptionParams($accessKey, $amount, $recurringFrequency, $description,
            $referenceId, $immediateReturn, $returnUrl, $abandonUrl, $processImmediate, $ipnUrl,$collectShippingAddress,
            $signatureMethod);
        ...
        $signature = SignatureUtils::signParameters($params, $secretKey,
            self::$httpMethod, $serviceEndPoint['host'], $serviceEndPoint['path'],$signatureMethod);
        $params[self::SIGNATURE_KEYNAME] = $signature;
        $simplePayForm = self::getSimplePaySubscribeForm($params,$endPoint,$imageLocation);
        return $simplePayForm;
    }
}
