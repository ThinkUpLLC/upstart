...
(function() {
  var $lastActiveDateGroup, animateContentShift, checkPasswordFormat, checkUsername, featureTest, pinDateMarker, setActiveDateGroup, setDateGroupData, setFixedPadding, setListOpenData, setNavHeight, timerUsername, wt;
  ...
  checkPasswordFormat = function(value) {
    var _ref;
    if (((_ref = value.match(/^(?=.*[0-9]+.*)(?=.*[a-zA-Z]+.*).{8,}$/gi)) != null ? _ref.length : void 0) === 1) {
      return true;
    } else {
  ...
  $(function() {
    ...
    $("#form-settings").on("submit", function(e) {
      $(this).find(".form-group").removeClass("form-group-warning");
      e.preventDefault();
      if ($(this).find("#control-password-current").val().length !== 0) {
        if ($(this).find("#control-password-new").val().length === 0 && $(this).find("#control-password-verify").val().length === 0) {
          ...
          $(this).find("#control-password-new").parent().addClass("form-group-warning");
          return e.preventDefault();
