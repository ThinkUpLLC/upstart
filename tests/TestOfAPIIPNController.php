...
class TestOfAPIIPNController extends UpstartUnitTestCase {
    ...
    public function testControlPaymentSuccessfulMonthly() {
        $builders = array();
        $builders[] = FixtureBuilder::build('subscription_operations',
            array('amazon_subscription_id'=>'a9b486d3-95cf-4587-957f-61da63030f55', 'subscriber_id'=>'5',
            'operation'=>'pay', 'payment_reason'=>'ThinkUp.com membership', 'recurring_frequency'=>'1 month'));
        $builders[] = FixtureBuilder::build('subscribers', array('id'=>'5', 'subscription_status'=>'Paid',
            'subscription_recurrence'=>'1 month'));
        ...
        $this->assertEqual("2014-12-12 16:15:18", $subscriber->paid_through);
    }

    public function testControlPaymentSuccessfulAnnual() {
        $builders = array();
        $builders[] = FixtureBuilder::build('subscription_operations',
            array('amazon_subscription_id'=>'a9b486d3-95cf-4587-957f-61da63030f55', 'subscriber_id'=>'5',
            'operation'=>'pay', 'payment_reason'=>'ThinkUp.com membership', 'recurring_frequency'=>'12 months'));
        $builders[] = FixtureBuilder::build('subscribers', array('id'=>'5', 'subscription_status'=>'Paid',
            'subscription_recurrence'=>'1 month'));
        ...
        $subscriber = $subscriber_dao->getByID($op->subscriber_id);
        $this->assertEqual("Paid", $subscriber->subscription_status);
        $this->assertEqual("2015-11-12 16:15:18", $subscriber->paid_through);
    }
