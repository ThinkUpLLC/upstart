...
class TestOfBundleController extends UpstartUnitTestCase {
    ...
    public function testOfControllerNoParams() {
        ...
        $this->assertPattern( '/Buy it now/', $result);
    }
    ...
    public function testOfControllerAllParamsValidSig() {
        ...
        $this->assertEqual($v_mgr->getTemplateDataItem('success_msg'),
            'Success! You\'ve purchased The Better Web Bundle 2014');

        $confirmation_email = Mailer::getLastMail();
        $this->debug($confirmation_email);
        $this->assertPattern('/Thanks for purchasing The Better Web Bundle 2014/', $confirmation_email);
    }
