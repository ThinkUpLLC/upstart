            ...
            <tr>
              <td class="wrapper last">
                ...
                <table class="twelve columns">
                  <tr>
                    <td>
                      <a href="https://www.thinkup.com/join/user/membership.php"><img width="580" height="479" src="http://dev.upstart.com/assets/img/email/reminder-1-promo.png"
                ...
                <table class="twelve columns">
                  <tr>
                    <td class="text-pad center">
                      <p style="text-align:center;">Check out your ThinkUp stream at <a href="https://{$thinkup_username}.thinkup.com">{$thinkup_username}.thinkup.com</a></p>
