                    ...
                    <tr>
                      <td class="wrapper last">
                        ...
                        <table class="twelve columns" align="center">
                          <tr>
                              <td class="center">
                                  <center><a href="https://thinkup.com" style="text-decoration:none;"><img class="center" src="https://www.thinkup.com/join/assets/img/thinkup-logo-header.png" alt="ThinkUp" width="70" height="19"></a></center>
                            </td>
                            <td class="expander"></td>
                          </tr>
                        </table>
