            ...
            <tr>
              <td class="wrapper last">
                ...
                <table class="twelve columns">
                  <tr>
                    <td>
                      <a href="{$site_url}user/membership.php"><img width="580" height="360" src="https://thinkup.com/join/assets/img/email/reminder-4-promo-monthly-{if $membership_level eq 'Member'}member{else}pro{/if}.png"
